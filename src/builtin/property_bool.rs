...
//
//   ucd-generate.exe property-bool tests/UCD --chars
//
...
pub const ALPHABETIC: &'static [(char, char)] = &[
    ...
    ('\u{c00}', 'ఌ'), ('ఎ', 'ఐ'), ('ఒ', 'న'), ('ప', 'హ'),
    ('ఽ', 'ౄ'), ('\u{c46}', '\u{c48}'), ('\u{c4a}', '\u{c4c}'),
    ('\u{c55}', '\u{c56}'), ('ౘ', 'ౚ'), ('ౝ', 'ౝ'), ('ౠ', '\u{c63}'),
    ('ಀ', 'ಃ'), ('ಅ', 'ಌ'), ('ಎ', 'ಐ'), ('ಒ', 'ನ'),
    ('ಪ', 'ಳ'), ('ವ', 'ಹ'), ('ಽ', 'ೄ'), ('\u{cc6}', 'ೈ'),
    ('ೊ', '\u{ccc}'), ('\u{cd5}', '\u{cd6}'), ('ೝ', 'ೞ'),
    ('ೠ', '\u{ce3}'), ('ೱ', '\u{cf3}'), ('\u{d00}', 'ഌ'), ('എ', 'ഐ'),
    ('ഒ', 'ഺ'), ('ഽ', '\u{d44}'), ('െ', 'ൈ'), ('ൊ', 'ൌ'),
    ('ൎ', 'ൎ'), ('ൔ', '\u{d57}'), ('ൟ', '\u{d63}'), ('ൺ', 'ൿ'),
    ('\u{d81}', 'ඃ'), ('අ', 'ඖ'), ('ක', 'න'), ('ඳ', 'ර'),
    ('ල', 'ල'), ('ව', 'ෆ'), ('\u{dcf}', '\u{dd4}'),
    ...
    ('\u{1abf}', '\u{1ac0}'), ('\u{1acc}', '\u{1ace}'), ('\u{1b00}', 'ᬳ'),
    ('\u{1b35}', 'ᭃ'), ('ᭅ', 'ᭌ'), ('\u{1b80}', '\u{1ba9}'),
    ('\u{1bac}', 'ᮯ'), ('ᮺ', 'ᯥ'), ('ᯧ', '\u{1bf1}'),
    ('ᰀ', '\u{1c36}'), ('ᱍ', 'ᱏ'), ('ᱚ', 'ᱽ'), ('ᲀ', 'ᲈ'),
    ('Ა', 'Ჺ'), ('Ჽ', 'Ჿ'), ('ᳩ', 'ᳬ'), ('ᳮ', 'ᳳ'),
    ('ᳵ', 'ᳶ'), ('ᳺ', 'ᳺ'), ('ᴀ', 'ᶿ'), ('\u{1de7}', '\u{1df4}'),
    ('Ḁ', 'ἕ'), ('Ἐ', 'Ἕ'), ('ἠ', 'ὅ'), ('Ὀ', 'Ὅ'),
    ('ὐ', 'ὗ'), ('Ὑ', 'Ὑ'), ('Ὓ', 'Ὓ'), ('Ὕ', 'Ὕ'),
    ('Ὗ', 'ώ'), ('ᾀ', 'ᾴ'), ('ᾶ', 'ᾼ'), ('ι', 'ι'),
    ('ῂ', 'ῄ'), ('ῆ', 'ῌ'), ('ῐ', 'ΐ'), ('ῖ', 'Ί'),
    ...
    ('ꙿ', 'ꛯ'), ('ꜗ', 'ꜟ'), ('Ꜣ', 'ꞈ'), ('Ꞌ', 'ꟊ'),
    ('Ꟑ', 'ꟑ'), ('ꟓ', 'ꟓ'), ('ꟕ', 'ꟙ'), ('ꟲ', 'ꠅ'),
    ('ꠇ', 'ꠧ'), ('ꡀ', 'ꡳ'), ('ꢀ', 'ꣃ'), ('\u{a8c5}', '\u{a8c5}'),
    ('ꣲ', 'ꣷ'), ('ꣻ', 'ꣻ'), ('ꣽ', '\u{a8ff}'), ('ꤊ', '\u{a92a}'),
    ('ꤰ', 'ꥒ'), ('ꥠ', 'ꥼ'), ('\u{a980}', 'ꦲ'), ('ꦴ', 'ꦿ'),
    ('ꧏ', 'ꧏ'), ('ꧠ', 'ꧯ'), ('ꧺ', 'ꧾ'), ('ꨀ', '\u{aa36}'),
    ('ꩀ', 'ꩍ'), ('ꩠ', 'ꩶ'), ('ꩺ', '\u{aabe}'), ('ꫀ', 'ꫀ'),
    ('ꫂ', 'ꫂ'), ('ꫛ', 'ꫝ'), ('ꫠ', 'ꫯ'), ('ꫲ', 'ꫵ'),
    ('ꬁ', 'ꬆ'), ('ꬉ', 'ꬎ'), ('ꬑ', 'ꬖ'), ('ꬠ', 'ꬦ'),
    ('ꬨ', 'ꬮ'), ('ꬰ', 'ꭚ'), ('ꭜ', 'ꭩ'), ('ꭰ', 'ꯪ'),
    ('가', '힣'), ('ힰ', 'ퟆ'), ('ퟋ', 'ퟻ'), ('豈', '舘'),
    ...
    ('\u{1171d}', '\u{1172a}'), ('𑝀', '𑝆'), ('𑠀', '𑠸'),
    ('𑢠', '𑣟'), ('𑣿', '𑤆'), ('𑤉', '𑤉'), ('𑤌', '𑤓'),
    ('𑤕', '𑤖'), ('𑤘', '𑤵'), ('𑤷', '𑤸'),
    ('\u{1193b}', '\u{1193c}'), ('𑤿', '𑥂'), ('𑦠', '𑦧'),
    ('𑦪', '\u{119d7}'), ('\u{119da}', '𑧟'), ('𑧡', '𑧡'),
    ('𑧣', '𑧤'), ('𑨀', '𑨲'), ('\u{11a35}', '\u{11a3e}'),
    ('𑩐', '𑪗'), ('𑪝', '𑪝'), ('𑪰', '𑫸'), ('𑰀', '𑰈'),
    ...
    ('𑻠', '𑻶'), ('\u{11f00}', '\u{11f10}'), ('\u{11f12}', '\u{11f3a}'),
    ('\u{11f3e}', '\u{11f40}'), ('𑾰', '𑾰'), ('𒀀', '𒎙'),
    ('𒐀', '𒑮'), ('𒒀', '𒕃'), ('𒾐', '𒿰'), ('𓀀', '\u{1342f}'),
    ('\u{13441}', '\u{13446}'), ('𔐀', '𔙆'), ('𖠀', '𖨸'),
    ('𖩀', '𖩞'), ('𖩰', '𖪾'), ('𖫐', '𖫭'), ('𖬀', '𖬯'),
    ('𖭀', '𖭃'), ('𖭣', '𖭷'), ('𖭽', '𖮏'), ('𖹀', '𖹿'),
    ('𖼀', '𖽊'), ('\u{16f4f}', '𖾇'), ('\u{16f8f}', '𖾟'),
    ('𖿠', '𖿡'), ('𖿣', '𖿣'), ('𖿰', '𖿱'), ('𗀀', '𘟷'),
    ('𘠀', '𘳕'), ('𘴀', '𘴈'), ('𚿰', '𚿳'), ('𚿵', '𚿻'),
    ('𚿽', '𚿾'), ('𛀀', '𛄢'), ('\u{1b132}', '\u{1b132}'),
    ('𛅐', '𛅒'), ('\u{1b155}', '\u{1b155}'), ('𛅤', '𛅧'),
    ('𛅰', '𛋻'), ('𛰀', '𛱪'), ('𛱰', '𛱼'), ('𛲀', '𛲈'),
    ...
    ('𝛜', '𝛺'), ('𝛼', '𝜔'), ('𝜖', '𝜴'), ('𝜶', '𝝎'),
    ('𝝐', '𝝮'), ('𝝰', '𝞈'), ('𝞊', '𝞨'), ('𝞪', '𝟂'),
    ('𝟄', '𝟋'), ('𝼀', '𝼞'), ('\u{1df25}', '\u{1df2a}'),
    ('\u{1e000}', '\u{1e006}'), ('\u{1e008}', '\u{1e018}'),
    ('\u{1e01b}', '\u{1e021}'), ('\u{1e023}', '\u{1e024}'),
    ('\u{1e026}', '\u{1e02a}'), ('\u{1e030}', '\u{1e06d}'),
    ('\u{1e08f}', '\u{1e08f}'), ('𞄀', '𞄬'), ('𞄷', '𞄽'),
    ('𞅎', '𞅎'), ('𞊐', '𞊭'), ('𞋀', '𞋫'),
    ('\u{1e4d0}', '\u{1e4eb}'), ('𞟠', '𞟦'), ('𞟨', '𞟫'),
    ('𞟭', '𞟮'), ('𞟰', '𞟾'), ('𞠀', '𞣄'), ('𞤀', '𞥃'),
    ...
    ('𞺋', '𞺛'), ('𞺡', '𞺣'), ('𞺥', '𞺩'), ('𞺫', '𞺻'),
    ('🄰', '🅉'), ('🅐', '🅩'), ('🅰', '🆉'), ('𠀀', '𪛟'),
    ('𪜀', '\u{2b739}'), ('𫝀', '𫠝'), ('𫠠', '𬺡'), ('𬺰', '𮯠'),
    ('丽', '𪘀'), ('𰀀', '𱍊'), ('\u{31350}', '\u{323af}'),
];
...
pub const CASE_IGNORABLE: &'static [(char, char)] = &[
    ...
    ('\u{1a7f}', '\u{1a7f}'), ('ᪧ', 'ᪧ'), ('\u{1ab0}', '\u{1ace}'),
    ...
    ('\u{1e030}', '\u{1e06d}'), ('\u{1e08f}', '\u{1e08f}'),
    ('\u{1e130}', '𞄽'), ('\u{1e2ae}', '\u{1e2ae}'),
    ('\u{1e2ec}', '\u{1e2ef}'), ('\u{1e4eb}', '\u{1e4ef}'),
    ('\u{1e8d0}', '\u{1e8d6}'), ('\u{1e944}', '𞥋'), ('🏻', '🏿'),
...
pub const DIACRITIC: &'static [(char, char)] = &[
    ...
    ('ႇ', '\u{108d}'), ('ႏ', 'ႏ'), ('ႚ', 'ႛ'),
    ('\u{135d}', '\u{135f}'), ('\u{1714}', '᜕'), ('\u{17c9}', '\u{17d3}'),
    ('\u{17dd}', '\u{17dd}'), ('\u{1939}', '\u{193b}'),
    ('\u{1a75}', '\u{1a7c}'), ('\u{1a7f}', '\u{1a7f}'),
    ('\u{1ab0}', '\u{1abe}'), ('\u{1ac1}', '\u{1acb}'),
    ('\u{1b34}', '\u{1b34}'), ('᭄', '᭄'), ('\u{1b6b}', '\u{1b73}'),
    ('᮪', '\u{1bab}'), ('\u{1c36}', '\u{1c37}'), ('ᱸ', 'ᱽ'),
    ('\u{1cd0}', '\u{1ce8}'), ('\u{1ced}', '\u{1ced}'),
    ('\u{1cf4}', '\u{1cf4}'), ('᳷', '\u{1cf9}'), ('ᴬ', 'ᵪ'),
    ('\u{1dc4}', '\u{1dcf}'), ('\u{1df5}', '\u{1dff}'), ('᾽', '᾽'),
    ('᾿', '῁'), ('῍', '῏'), ('῝', '῟'), ('῭', '`'),
    ('´', '῾'), ('\u{2cef}', '\u{2cf1}'), ('ⸯ', 'ⸯ'),
    ('\u{302a}', '\u{302f}'), ('\u{3099}', '゜'), ('ー', 'ー'),
    ('\u{a66f}', '\u{a66f}'), ('\u{a67c}', '\u{a67d}'), ('ꙿ', 'ꙿ'),
    ('ꚜ', 'ꚝ'), ('\u{a6f0}', '\u{a6f1}'), ('꜀', '꜡'), ('ꞈ', '꞊'),
    ('ꟸ', 'ꟹ'), ('\u{a8c4}', '\u{a8c4}'), ('\u{a8e0}', '\u{a8f1}'),
    ('\u{a92b}', '꤮'), ('꥓', '꥓'), ('\u{a9b3}', '\u{a9b3}'),
    ('꧀', '꧀'), ('\u{a9e5}', '\u{a9e5}'), ('ꩻ', 'ꩽ'),
    ('\u{aabf}', 'ꫂ'), ('\u{aaf6}', '\u{aaf6}'), ('꭛', 'ꭟ'),
    ('ꭩ', '꭫'), ('꯬', '\u{abed}'), ('\u{fb1e}', '\u{fb1e}'),
    ('\u{fe20}', '\u{fe2f}'), ('＾', '＾'), ('｀', '｀'), ('ｰ', 'ｰ'),
    ('\u{ff9e}', '\u{ff9f}'), ('￣', '￣'), ('\u{102e0}', '\u{102e0}'),
    ('𐞀', '𐞅'), ('𐞇', '𐞰'), ('𐞲', '𐞺'),
    ('\u{10ae5}', '\u{10ae6}'), ('𐴢', '\u{10d27}'),
    ('\u{10efd}', '\u{10eff}'), ('\u{10f46}', '\u{10f50}'),
    ('\u{10f82}', '\u{10f85}'), ('\u{11046}', '\u{11046}'),
    ('\u{11070}', '\u{11070}'), ('\u{110b9}', '\u{110ba}'),
    ...
    ('\u{1d1aa}', '\u{1d1ad}'), ('\u{1e030}', '\u{1e06d}'),
...
pub const EMOJI: &'static [(char, char)] = &[
    ...
    ('🛰', '🛰'), ('🛳', '🛼'), ('🟠', '🟫'), ('🟰', '🟰'),
    ('🤌', '🤺'), ('🤼', '🥅'), ('🥇', '🧿'), ('🩰', '🩼'),
    ('🪀', '\u{1fa88}'), ('🪐', '\u{1fabd}'), ('\u{1fabf}', '🫅'),
    ('\u{1face}', '\u{1fadb}'), ('🫠', '\u{1fae8}'), ('🫰', '\u{1faf8}'),
];
...
pub const EMOJI_PRESENTATION: &'static [(char, char)] = &[
    ...
    ('🛴', '🛼'), ('🟠', '🟫'), ('🟰', '🟰'), ('🤌', '🤺'),
    ('🤼', '🥅'), ('🥇', '🧿'), ('🩰', '🩼'), ('🪀', '\u{1fa88}'),
    ('🪐', '\u{1fabd}'), ('\u{1fabf}', '🫅'), ('\u{1face}', '\u{1fadb}'),
    ('🫠', '\u{1fae8}'), ('🫰', '\u{1faf8}'),
];
...
pub const GRAPHEME_BASE: &'static [(char, char)] = &[
    ...
    ('𑵪', '𑶎'), ('𑶓', '𑶔'), ('𑶖', '𑶖'), ('𑶘', '𑶘'),
    ('𑶠', '𑶩'), ('𑻠', '𑻲'), ('𑻵', '𑻸'),
    ('\u{11f02}', '\u{11f10}'), ('\u{11f12}', '\u{11f35}'),
    ('\u{11f3e}', '\u{11f3f}'), ('\u{11f41}', '\u{11f41}'),
    ('\u{11f43}', '\u{11f59}'), ('𑾰', '𑾰'), ('𑿀', '𑿱'),
    ('𑿿', '𒎙'), ('𒐀', '𒑮'), ('𒑰', '𒑴'), ('𒒀', '𒕃'),
    ('𒾐', '𒿲'), ('𓀀', '\u{1342f}'), ('\u{13441}', '\u{13446}'),
    ('𔐀', '𔙆'), ('𖠀', '𖨸'), ('𖩀', '𖩞'), ('𖩠', '𖩩'),
    ('𖩮', '𖪾'), ('𖫀', '𖫉'), ('𖫐', '𖫭'), ('𖫵', '𖫵'),
    ('𖬀', '𖬯'), ('𖬷', '𖭅'), ('𖭐', '𖭙'), ('𖭛', '𖭡'),
    ('𖭣', '𖭷'), ('𖭽', '𖮏'), ('𖹀', '𖺚'), ('𖼀', '𖽊'),
    ...
    ('𝚨', '𝟋'), ('𝟎', '𝧿'), ('𝨷', '𝨺'), ('𝩭', '𝩴'),
    ('𝩶', '𝪃'), ('𝪅', '𝪋'), ('𝼀', '𝼞'),
    ('\u{1df25}', '\u{1df2a}'), ('\u{1e030}', '\u{1e06d}'), ('𞄀', '𞄬'),
    ('𞄷', '𞄽'), ('𞅀', '𞅉'), ('𞅎', '𞅏'), ('𞊐', '𞊭'),
    ('𞋀', '𞋫'), ('𞋰', '𞋹'), ('𞋿', '𞋿'),
    ('\u{1e4d0}', '\u{1e4eb}'), ('\u{1e4f0}', '\u{1e4f9}'), ('𞟠', '𞟦'),
    ('𞟨', '𞟫'), ('𞟭', '𞟮'), ('𞟰', '𞟾'), ('𞠀', '𞣄'),
    ('𞣇', '𞣏'), ('𞤀', '𞥃'), ('𞥋', '𞥋'), ('𞥐', '𞥙'),
    ('𞥞', '𞥟'), ('𞱱', '𞲴'), ('𞴁', '𞴽'), ('𞸀', '𞸃'),
    ('𞸅', '𞸟'), ('𞸡', '𞸢'), ('𞸤', '𞸤'), ('𞸧', '𞸧'),
...
pub const GRAPHEME_LINK: &'static [(char, char)] = &[
    ...
    ('\u{1714}', '᜕'), ('᜴', '᜴'), ('\u{17d2}', '\u{17d2}'),
    ('\u{1a60}', '\u{1a60}'), ('᭄', '᭄'), ('᮪', '\u{1bab}'),
    ('᯲', '᯳'), ('\u{2d7f}', '\u{2d7f}'), ('\u{a806}', '\u{a806}'),
    ('\u{a82c}', '\u{a82c}'), ('\u{a8c4}', '\u{a8c4}'), ('꥓', '꥓'),
    ('꧀', '꧀'), ('\u{aaf6}', '\u{aaf6}'), ('\u{abed}', '\u{abed}'),
    ('\u{10a3f}', '\u{10a3f}'), ('\u{11046}', '\u{11046}'),
    ('\u{11070}', '\u{11070}'), ('\u{1107f}', '\u{1107f}'),
    ('\u{110b9}', '\u{110b9}'), ('\u{11133}', '\u{11134}'), ('𑇀', '𑇀'),
    ('𑈵', '𑈵'), ('\u{112ea}', '\u{112ea}'), ('𑍍', '𑍍'),
    ('\u{11442}', '\u{11442}'), ('\u{114c2}', '\u{114c2}'),
    ('\u{115bf}', '\u{115bf}'), ('\u{1163f}', '\u{1163f}'), ('𑚶', '𑚶'),
    ('\u{1172b}', '\u{1172b}'), ('\u{11839}', '\u{11839}'),
    ('𑤽', '\u{1193e}'), ('\u{119e0}', '\u{119e0}'),
...
pub const ID_CONTINUE: &'static [(char, char)] = &[
    ...
    ('𒀀', '𒎙'), ('𒐀', '𒑮'), ('𒒀', '𒕃'), ('𒾐', '𒿰'),
    ('𓀀', '\u{1342f}'), ('\u{13440}', '\u{13455}'), ('𔐀', '𔙆'),
    ('𖠀', '𖨸'), ('𖩀', '𖩞'), ('𖩠', '𖩩'), ('𖩰', '𖪾'),
    ('𖫀', '𖫉'), ('𖫐', '𖫭'), ('\u{16af0}', '\u{16af4}'),
    ...
    ('\u{1da3b}', '\u{1da6c}'), ('\u{1da75}', '\u{1da75}'),
    ('\u{1da84}', '\u{1da84}'), ('\u{1da9b}', '\u{1da9f}'),
    ('\u{1daa1}', '\u{1daaf}'), ('𝼀', '𝼞'), ('\u{1df25}', '\u{1df2a}'),
    ('\u{1e000}', '\u{1e006}'), ('\u{1e008}', '\u{1e018}'),
    ('\u{1e01b}', '\u{1e021}'), ('\u{1e023}', '\u{1e024}'),
    ('\u{1e026}', '\u{1e02a}'), ('\u{1e030}', '\u{1e06d}'),
    ('\u{1e08f}', '\u{1e08f}'), ('𞄀', '𞄬'), ('\u{1e130}', '𞄽'),
    ('𞅀', '𞅉'), ('𞅎', '𞅎'), ('𞊐', '\u{1e2ae}'), ('𞋀', '𞋹'),
    ('\u{1e4d0}', '\u{1e4f9}'), ('𞟠', '𞟦'), ('𞟨', '𞟫'),
    ('𞟭', '𞟮'), ('𞟰', '𞟾'), ('𞠀', '𞣄'),
...
pub const ID_START: &'static [(char, char)] = &[
    ...
    ('𑴈', '𑴉'), ('𑴋', '𑴰'), ('𑵆', '𑵆'), ('𑵠', '𑵥'),
    ('𑵧', '𑵨'), ('𑵪', '𑶉'), ('𑶘', '𑶘'), ('𑻠', '𑻲'),
    ('\u{11f02}', '\u{11f02}'), ('\u{11f04}', '\u{11f10}'),
    ('\u{11f12}', '\u{11f33}'), ('𑾰', '𑾰'), ('𒀀', '𒎙'),
    ('𒐀', '𒑮'), ('𒒀', '𒕃'), ('𒾐', '𒿰'), ('𓀀', '\u{1342f}'),
    ('\u{13441}', '\u{13446}'), ('𔐀', '𔙆'), ('𖠀', '𖨸'),
    ('𖩀', '𖩞'), ('𖩰', '𖪾'), ('𖫐', '𖫭'), ('𖬀', '𖬯'),
    ('𖭀', '𖭃'), ('𖭣', '𖭷'), ('𖭽', '𖮏'), ('𖹀', '𖹿'),
    ...
    ('𝛼', '𝜔'), ('𝜖', '𝜴'), ('𝜶', '𝝎'), ('𝝐', '𝝮'),
    ('𝝰', '𝞈'), ('𝞊', '𝞨'), ('𝞪', '𝟂'), ('𝟄', '𝟋'),
    ('𝼀', '𝼞'), ('\u{1df25}', '\u{1df2a}'), ('\u{1e030}', '\u{1e06d}'),
    ('𞄀', '𞄬'), ('𞄷', '𞄽'), ('𞅎', '𞅎'), ('𞊐', '𞊭'),
    ('𞋀', '𞋫'), ('\u{1e4d0}', '\u{1e4eb}'), ('𞟠', '𞟦'),
    ('𞟨', '𞟫'), ('𞟭', '𞟮'), ('𞟰', '𞟾'), ('𞠀', '𞣄'),
    ('𞤀', '𞥃'), ('𞥋', '𞥋'), ('𞸀', '𞸃'), ('𞸅', '𞸟'),
    ('𞸡', '𞸢'), ('𞸤', '𞸤'), ('𞸧', '𞸧'), ('𞸩', '𞸲'),
    ('𞸴', '𞸷'), ('𞸹', '𞸹'), ('𞸻', '𞸻'), ('𞹂', '𞹂'),
...
pub const OTHER_ALPHABETIC: &'static [(char, char)] = &[
    ...
    ('\u{cd5}', '\u{cd6}'), ('\u{ce2}', '\u{ce3}'), ('\u{cf3}', '\u{cf3}'),
    ('\u{d00}', 'ഃ'), ('\u{d3e}', '\u{d44}'), ('െ', 'ൈ'), ('ൊ', 'ൌ'),
    ...
    ('\u{ebb}', '\u{ebc}'), ('\u{ecd}', '\u{ecd}'), ('\u{f71}', '\u{f83}'),
    ...
    ('ᩡ', '\u{1a74}'), ('\u{1abf}', '\u{1ac0}'), ('\u{1acc}', '\u{1ace}'),
    ('\u{1b00}', 'ᬄ'), ('\u{1b35}', 'ᭃ'), ('\u{1b80}', 'ᮂ'),
    ('ᮡ', '\u{1ba9}'), ('\u{1bac}', '\u{1bad}'), ('ᯧ', '\u{1bf1}'),
    ('ᰤ', '\u{1c36}'), ('\u{1de7}', '\u{1df4}'), ('Ⓐ', 'ⓩ'),
    ...
    ('\u{11930}', '𑤵'), ('𑤷', '𑤸'), ('\u{1193b}', '\u{1193c}'),
    ('𑥀', '𑥀'), ('𑥂', '𑥂'), ('𑧑', '\u{119d7}'),
    ('\u{119da}', '𑧟'), ('𑧤', '𑧤'), ('\u{11a01}', '\u{11a0a}'),
    ('\u{11a35}', '𑨹'), ('\u{11a3b}', '\u{11a3e}'),
    ('\u{11a51}', '\u{11a5b}'), ('\u{11a8a}', '𑪗'), ('𑰯', '\u{11c36}'),
    ...
    ('\u{11f00}', '\u{11f01}'), ('\u{11f03}', '\u{11f03}'),
    ('\u{11f34}', '\u{11f3a}'), ('\u{11f3e}', '\u{11f40}'),
    ('\u{16f4f}', '\u{16f4f}'), ('𖽑', '𖾇'), ('\u{16f8f}', '\u{16f92}'),
    ('𖿰', '𖿱'), ('\u{1bc9e}', '\u{1bc9e}'), ('\u{1e000}', '\u{1e006}'),
    ('\u{1e008}', '\u{1e018}'), ('\u{1e01b}', '\u{1e021}'),
    ('\u{1e023}', '\u{1e024}'), ('\u{1e026}', '\u{1e02a}'),
    ('\u{1e08f}', '\u{1e08f}'), ('\u{1e947}', '\u{1e947}'), ('🄰', '🅉'),
    ('🅐', '🅩'), ('🅰', '🆉'),
];
...
pub const XID_START: &'static [(char, char)] = &[
    ...
    ('𑱲', '𑲏'), ('𑴀', '𑴆'), ('𑴈', '𑴉'), ('𑴋', '𑴰'),
    ('𑵆', '𑵆'), ('𑵠', '𑵥'), ('𑵧', '𑵨'), ('𑵪', '𑶉'),
    ('𑶘', '𑶘'), ('𑻠', '𑻲'), ('\u{11f02}', '\u{11f02}'),
    ('\u{11f04}', '\u{11f10}'), ('\u{11f12}', '\u{11f33}'), ('𑾰', '𑾰'),
    ('𒀀', '𒎙'), ('𒐀', '𒑮'), ('𒒀', '𒕃'), ('𒾐', '𒿰'),
    ('𓀀', '\u{1342f}'), ('\u{13441}', '\u{13446}'), ('𔐀', '𔙆'),
    ('𖠀', '𖨸'), ('𖩀', '𖩞'), ('𖩰', '𖪾'), ('𖫐', '𖫭'),
    ('𖬀', '𖬯'), ('𖭀', '𖭃'), ('𖭣', '𖭷'), ('𖭽', '𖮏'),
    ('𖹀', '𖹿'), ('𖼀', '𖽊'), ('𖽐', '𖽐'), ('𖾓', '𖾟'),
    ('𖿠', '𖿡'), ('𖿣', '𖿣'), ('𗀀', '𘟷'), ('𘠀', '𘳕'),
    ('𘴀', '𘴈'), ('𚿰', '𚿳'), ('𚿵', '𚿻'), ('𚿽', '𚿾'),
    ('𛀀', '𛄢'), ('\u{1b132}', '\u{1b132}'), ('𛅐', '𛅒'),
    ('\u{1b155}', '\u{1b155}'), ('𛅤', '𛅧'), ('𛅰', '𛋻'),
    ('𛰀', '𛱪'), ('𛱰', '𛱼'), ('𛲀', '𛲈'), ('𛲐', '𛲙'),
    ('𝐀', '𝑔'), ('𝑖', '𝒜'), ('𝒞', '𝒟'), ('𝒢', '𝒢'),
    ('𝒥', '𝒦'), ('𝒩', '𝒬'), ('𝒮', '𝒹'), ('𝒻', '𝒻'),
    ('𝒽', '𝓃'), ('𝓅', '𝔅'), ('𝔇', '𝔊'), ('𝔍', '𝔔'),
