...
//
//   ucd-generate.exe sentence-break tests/UCD --chars
//
...
pub const LOWER: &'static [(char, char)] = &[
  ...
  ('𝝰', '𝞈'), ('𝞊', '𝞏'), ('𝞪', '𝟂'), ('𝟄', '𝟉'),
  ('𝟋', '𝟋'), ('𝼀', '𝼉'), ('𝼋', '𝼞'),
  ('\u{1df25}', '\u{1df2a}'), ('\u{1e030}', '\u{1e06d}'), ('𞤢', '𞥃'),
];
...
pub const NUMERIC: &'static [(char, char)] = &[
  ...
  ('𑑐', '𑑙'), ('𑓐', '𑓙'), ('𑙐', '𑙙'), ('𑛀', '𑛉'),
  ('𑜰', '𑜹'), ('𑣠', '𑣩'), ('𑥐', '𑥙'), ('𑱐', '𑱙'),
  ('𑵐', '𑵙'), ('𑶠', '𑶩'), ('\u{11f50}', '\u{11f59}'),
  ('𖩠', '𖩩'), ('𖫀', '𖫉'), ('𖭐', '𖭙'), ('𝟎', '𝟿'),
  ('𞅀', '𞅉'), ('𞋰', '𞋹'), ('\u{1e4f0}', '\u{1e4f9}'),
  ('𞥐', '𞥙'), ('🯰', '🯹'),
];
...
pub const OLETTER: &'static [(char, char)] = &[
  ...
  ('𑴀', '𑴆'), ('𑴈', '𑴉'), ('𑴋', '𑴰'), ('𑵆', '𑵆'),
  ('𑵠', '𑵥'), ('𑵧', '𑵨'), ('𑵪', '𑶉'), ('𑶘', '𑶘'),
  ('𑻠', '𑻲'), ('\u{11f02}', '\u{11f02}'), ('\u{11f04}', '\u{11f10}'),
